...
- 与已存档作者重叠：当前 `authors.json` 未见已建档 Qwen 作者；[2606.12370 Bebop](/papers/2606.12370-bebop-mtp-rejection-sampling-rl-training/) 与当前报告存在多名直接重叠作者，包括 An Yang、Bowen Yu、Bo Zheng、Fan Zhou、Rui Men、Jianwei Zhang、Jianxin Yang、Fei Huang、Junyang Lin、Dayiheng Liu、Jingren Zhou。
