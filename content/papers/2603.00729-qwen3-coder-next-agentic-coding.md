...
- Proposed form: 新建独立 Markdown 文档，并更新索引行、对应论文的关系章节与作者档案。
...
- Overlap with existing assets: 与 Qwen2.5 / Qwen3 的关系写入本笔记的 `跨论文关系`，用于区分 foundation model report 与 coding-agent report。
