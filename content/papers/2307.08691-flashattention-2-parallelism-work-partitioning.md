...
### 5. Block Tiling 层：一次 forward kernel 如何跑
...
### 7. Backward 数据流层：用重算换 HBM traffic
...
### 8. Thread-block / SM 调度层：沿 sequence dimension 增加 parallelism
...
### 9. Warp-level 分工层：从 sliced-K 到 sliced-Q
...
### 10. 特殊模式与 tuning 层：causal mask、MQA/GQA、block size 与 head dimension
