...
- 与 [RL Credit Assignment Watch](/papers/2026-07-13-rl-credit-assignment-may-july-landscape/) 的关系：该综述快照把 GraphGPO 放在 2026 年 5 月的结构先验路线中；本笔记进一步把它定位为批次内、任务特定的非参数进度估计器，并补充状态合并、图覆盖和实现差异。
