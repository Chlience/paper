...
- 与 [VERL](/papers/2026-06-16-verl-rl-optimization-algorithms/) 和 [HybridFlow](/papers/2409.19256-hybridflow-rlhf-framework/)：本文训练与 profiling 建立在 VERL 上，新增逻辑位于 data scheduling 和 update selection；框架版本与具体改动尚未披露。
...
- Existing related assets: `content/utility/papers-index.md`；[DAPO](/papers/2503.14476-dapo-long-cot-rl-system/)；[VERL](/papers/2026-06-16-verl-rl-optimization-algorithms/)；[HybridFlow](/papers/2409.19256-hybridflow-rlhf-framework/)。
...
- Overlap with existing assets: 与 VERL、DAPO、Laminar 的内容通过 workload 与算法层边界区分。
