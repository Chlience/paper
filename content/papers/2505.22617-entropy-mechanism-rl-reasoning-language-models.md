...
- 与 [verl 官方仓库](https://github.com/verl-project/verl)：本篇的 Clip-Cov / KL-Cov 已进入 verl recipe；verl 中的 KL/K3/chi2、rollout correction 和 loss mode 适合承载本篇指标。
