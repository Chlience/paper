...
- 与 [Prefill CP](/papers/2026-07-14-prefill-context-parallelism-inference-scaling/)：该综合把 Ring Attention 定位为 CP 的 pass-KV 实现族，并与 SGLang 的 local-Q + full-KV all-gather、Meta inference CP 的 pass-KV / pass-Q、Ulysses layout transpose 对照；共同契约是 local query 能访问全局因果 context，内存和 collective 路径各异。
