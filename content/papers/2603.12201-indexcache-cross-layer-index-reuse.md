...
- 已存档作者重叠：Yushi Bai 后续出现在 [HiLS-Attention](/papers/2607.02980-hils-attention-infinite-context/)；Xin Lv 连接 [slime](/papers/2026-06-17-slime-rl-scaling-framework/)；Jie Tang 同时参与 [SAO](/papers/2607.07508-sao-single-rollout-asynchronous-agentic-rl/) 与 [CompactionRL](/papers/2607.05378-compactionrl-context-compaction-agent-rl/)。
...
- 与 [Vortex](/papers/2606.06453-vortex-sparse-attention-serving/)：IndexCache 定义哪些层运行 selector，以及 indices 如何跨层流动；Vortex 将 selector 与 selected-attention 编译成 serving operators。二者可以组合，当前尚无公开集成证据。
...
- 与 [slime](/papers/2026-06-17-slime-rl-scaling-framework/)、[SAO](/papers/2607.07508-sao-single-rollout-asynchronous-agentic-rl/) 和 [CompactionRL](/papers/2607.05378-compactionrl-context-compaction-agent-rl/)：Xin Lv、Jie Tang 等作者连接 Z.ai 的长上下文模型效率与 agentic RL 系统线。当前关系是人员和生产模型栈重叠，IndexCache 本身不包含 RL 算法。

## Reference Intake Brief

### Target

- Intended target system: 新增 IndexCache 独立论文笔记，并收紧 GLM-5 / GLM-5.2、DSA、Vortex、HiLS 与 FlashMemory 的方法关系。
- Existing related assets: `content/utility/papers-index.md`；[GLM-5](/papers/2602.15763-glm-5-agentic-engineering/)；[GLM-5.2](/papers/2026-06-16-glm-5-2-long-horizon-tasks/)；[DeepSeek-V3.2 / DSA](/papers/2512.02556-deepseek-v3-2-open-large-language-models/)；[Vortex](/papers/2606.06453-vortex-sparse-attention-serving/)；[FlashMemory](/papers/2606.09079-flashmemory-deepseek-v4-lookahead-sparse-attention/)；[HiLS-Attention](/papers/2607.02980-hils-attention-infinite-context/)。
