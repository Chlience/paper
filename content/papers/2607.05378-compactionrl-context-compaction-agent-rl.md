...
### 6. Segment、共享 reward 与可训练 token
...
### 7. Actor、summarizer 与 critic 的参数关系
...
### 8. Token-level PPO normalization
...
### 9. Cross-trajectory GAE 如何分配 advantage
