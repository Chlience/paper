...
- 与 [2409.19256](/papers/2409.19256-hybridflow-rlhf-framework/) 和 [verl 官方仓库](https://github.com/verl-project/verl)：HybridFlow/VERL 编排 RLHF/RLVR 多模型 dataflow；ZeRO/FSDP 类分片决定 actor、critic、reference、reward model 的训练侧显存边界。
- 与 [slime 官方仓库](https://github.com/THUDM/slime) 和 [2602.15763](/papers/2602.15763-glm-5-agentic-engineering/)：slime/GLM-5 把 Megatron training、SGLang rollout、async RL 和 weight sync 放进 production post-training stack；ZeRO 是理解其 optimizer/gradient/parameter sharding 的基础语言。
