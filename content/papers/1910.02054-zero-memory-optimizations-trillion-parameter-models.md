...
### 6. ZeRO-DP Stage 1: optimizer state partitioning $P_{os}$
...
### 7. ZeRO-DP Stage 2: gradient partitioning $P_{os+g}$
...
### 8. ZeRO-DP Stage 3: parameter partitioning $P_{os+g+p}$
...
### 10. ZeRO-R: residual memory optimizations
