...
- 与 `content/utility/papers-index.md` 中已有论文的作者关系：当前未发现与已存档论文的直接作者重叠。机构层面连接 Peking University / Baidu Inc. / USTC，其中 PKU 已在 DeepSeek、Xiaomi MiMo、MegaScale/UltraEP、MiniMax-M3 等节点多次出现，但该作者群未与这些节点确认同人。
...
- 新增后应更新的索引 cluster：新增 `ECHO / Source-Indexed Agentic Memory Credit Assignment` 节点，连接 agent memory、context management、tool-use RL、credit assignment 和 long-horizon rollout systems。
