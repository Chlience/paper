...
![Figure 3: ECHO memory selection and traceable credit assignment](/images/papers/2606.31650-echo-selective-turn-memory-agentic-rl/fig-3-memory-credit-overview.png)

Figure 3：上半部分展示 source-indexed turn memory 如何跨 sub-trajectory 选择并重建上下文；下半部分比较 GRPO/SUPO 的 dense all-token credit 与 ECHO 沿最终来源、memory selection 和 final segment 构造的稀疏 credit route。Image Source: [arXiv HTML Figure 3](https://arxiv.org/html/2606.31650v1/x3.png).
...
![Figure 1: ECHO accuracy, turn dynamics, and trajectory volume](/images/papers/2606.31650-echo-selective-turn-memory-agentic-rl/fig-1-accuracy-turn-volume.png)

Figure 1：BrowseComp-Plus 训练过程中，ECHO 同时取得更高 held-out accuracy，并把 turn 与 trajectory volume 控制在 SUPO 之下。Image Source: [arXiv HTML Figure 1](https://arxiv.org/html/2606.31650v1/x1.png).
...
![Figure 4a: ECHO memory component ablation](/images/papers/2606.31650-echo-selective-turn-memory-agentic-rl/fig-4a-memory-ablation.png)

Figure 4a：learned source selection 的准确率高于 semantic top-$k$；在相同 retrieval rule 下改用完整 observation 没有形成稳定增益。Image Source: [arXiv HTML Figure 4a](https://arxiv.org/html/2606.31650v1/x4.png).
...
![Figure 4b: ECHO credit assignment ablation](/images/papers/2606.31650-echo-selective-turn-memory-agentic-rl/fig-4b-credit-ablation.png)

Figure 4b：移除 traceable credit 后 accuracy 与稳定性下降；进一步使用 turn-level importance sampling 会出现更快的 turn growth。Image Source: [arXiv HTML Figure 4b](https://arxiv.org/html/2606.31650v1/x5.png).
