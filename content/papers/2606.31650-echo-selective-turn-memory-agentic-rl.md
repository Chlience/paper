...
- 与 [LLM 与 Agent 强化学习中的信用分配](/mainlines/llm-agent-rl-credit-assignment/)：该主线把 ECHO 定位为保留来源的正向信用路由器，并与 Memory-R2 的同状态重采样、HiMPO 的记忆反事实和 CompactionRL 的压缩状态 critic 分开比较；这收紧了“使用证据”与“估计证据边际贡献”的边界。
