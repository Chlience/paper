...
- 跨论文关系定位：记录 Seer、Synchronous RL Rollout 与 Group-Aware Context Learning，并连接 HybridFlow/VERL、GLM-5/slime、DAPO/GRPO、BroRL、MiniMax-M1、Span Query、Parrot、Vortex、TIM/VeXact。
