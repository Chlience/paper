...
- [Wei Liu](/authors/wei-liu-hkust/): HKUST.
- [Yuxuan Tong](/authors/yuxuan-tong/): Tsinghua University / ByteDance Seed.
- [Longtao Zheng](/authors/longtao-zheng/): ByteDance.
- [Zhenghai Xue](/authors/zhenghai-xue/): Nanyang Technological University.
- [Yaxiang Zhang](/authors/yaxiang-zhang/): National University of Singapore.
- [Tianle Cai](/authors/tianle-cai/): Princeton University.
- [Ge Zhang](/authors/ge-zhang/): M-A-P, ByteDance Seed, University of Waterloo.
- [Qian Liu](/authors/qian-liu/): TikTok AI Innovation Center / xAI.
...
- Intended target system: 新增论文笔记 `2602.07078-optimal-token-baseline-long-horizon-llm-rl.md`，并更新 `content/utility/papers-index.md` 与 `data/authors.json`。
