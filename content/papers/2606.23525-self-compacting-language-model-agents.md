...
- 与 [LLM 与 Agent 强化学习中的信用分配](/mainlines/llm-agent-rl-credit-assignment/)：SelfCompact 提供一条纯推理期 baseline，用于区分上下文重建本身的收益与 RL 信用分配的收益。它也暴露了该主线中的关键边界：压缩后的状态可比性会先于奖励路由影响 Agent 行为。
...
- Existing related assets: `content/utility/papers-index.md`；[CompactionRL](/papers/2607.05378-compactionrl-context-compaction-agent-rl/)；[ECHO](/papers/2606.31650-echo-selective-turn-memory-agentic-rl/)；[LLM 与 Agent 强化学习中的信用分配](/mainlines/llm-agent-rl-credit-assignment/)。
