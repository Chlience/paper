...
- 与 [slime 官方仓库](https://github.com/THUDM/slime) / [GLM-5](/papers/2602.15763-glm-5-agentic-engineering/)：slime/GLM-5 更明确披露 TITO、rollout logprob 与 direct IS；RollArt 更完整地覆盖异构资源池和 environment/reward placement。结合阅读可看出系统 overlap 与 RL correction 需要分别记录。
...
- Existing related assets: [HybridFlow / VERL](/papers/2409.19256-hybridflow-rlhf-framework/)、[Laminar](/papers/2510.12633-laminar-asynchronous-rl-post-training/)、[SAO](/papers/2607.07508-sao-single-rollout-asynchronous-agentic-rl/)。
