...
- 与 [SDFT](/papers/2601.19897-self-distillation-continual-learning/)：两者共享 Jonas Hübotter 与 Idan Shenfeld，也都使用 EMA 同模型、特权上下文和学生自身轨迹。SDFT 用 query-specific demonstration 解决新任务学习与旧能力保持；SDPO 用当前环境反馈形成 token 信用，并把测试时发现作为主要扩展。
