...
- 关系状态：本笔记的 `跨论文关系` 已把 GLM-5 / GLM-5.2 连接到 DeepSeek-V4、TIM/VeXact、HybridFlow/slime、tool-use RL、MiniMax-M1/CISPO、DAPO、Vortex/Parrot/Span Query 和 reward hacking。
