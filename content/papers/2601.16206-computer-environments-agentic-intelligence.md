...
- 与已有论文的方法或系统关系：[2602.13692 ThunderAgent](/papers/2602.13692-thunderagent-program-aware-agentic-inference/) 和 [2512.22560 RollArt](/papers/2512.22560-rollart-disaggregated-agentic-rl-training/) 解释 agentic serving / RL rollout 中 sandbox 生命周期、工具等待和异步调度的系统压力；LLM-in-Sandbox 提供 sandbox harness 与训练数据构造层面的上游对象。[2026-06-17 slime](/papers/2026-06-17-slime-rl-scaling-framework/) 提供把 sandbox rollout 接入大规模 RL 框架的系统接口语言。
...
- Existing related assets: `content/utility/papers-index.md`；已存档论文包括 ThunderAgent、RollArt、Kimi K2、GLM-5、DeepSeek-V4、slime、Self-Improving Agents。
