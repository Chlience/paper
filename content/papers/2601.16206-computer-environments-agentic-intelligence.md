...
- 与 `content/utility/papers-index.md` 中已有论文的作者关系：当前未发现直接作者重叠；机构层面连接 Renmin University of China、Microsoft Research 和 Tsinghua University，补充 RUC GSAI / Microsoft Research GenAI 的 agentic LLM training 线。
- 与已有论文的主题关系：它是 [OR-IUltZSgLMm Self-Improving Agents](/papers/2026-06-25-self-improving-agents-era-experience-survey/) 中 environment side / experience side 的具体实现节点；和 [2507.20534 Kimi K2](/papers/2507.20534-kimi-k2-open-agentic-intelligence/)、[2602.15763 GLM-5](/papers/2602.15763-glm-5-agentic-engineering/)、[2026-04-24 DeepSeek-V4](/papers/2026-04-24-deepseek-v4-million-token-context-intelligence/) 共享 sandbox + tool-use + agentic RL 主题。
...
- 新增后应更新的索引 cluster：更新 `Cluster BB: Self-Improving Agents、Harness 与 Experience Infrastructure`；新增或替换 `Cluster BD: LLM-in-Sandbox、Computer Environment 与 Sandbox-Agent Interaction`。
