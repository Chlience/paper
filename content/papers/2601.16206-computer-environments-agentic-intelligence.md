...
![Figure 1: LLM-in-Sandbox 的最小计算机环境与跨域使用方式](/images/papers/2601.16206-computer-environments-agentic-intelligence/fig-1-sandbox-overview.png)

Figure 1: 模型通过 `bash`、`file_editor` 和 `finish` 与通用 sandbox 循环交互，并在数学、物理、化学、生医、长上下文和指令遵循任务中组合外部资源、文件管理与代码执行。图中的跨域提升属于作者汇总；逐模型—任务单元仍包含下降结果。Image Source: [arXiv v3 HTML Figure 1](https://arxiv.org/html/2601.16206v3#S0.F1)。
...
- 证据定位：[Section 2.3, Table 2](https://arxiv.org/html/2601.16206v3#S2.T2)。
...
- 证据定位：[Section 2.4, Figure 2 与 Table 4](https://arxiv.org/html/2601.16206v3#S2.SS4)。
...
- 证据定位：[Section 2.4, Table 3](https://arxiv.org/html/2601.16206v3#S2.T3) 与 [Section 3.1, Table 5](https://arxiv.org/html/2601.16206v3#S3.T5)。
...
- 证据定位：[Section 3, Tables 5、6、7](https://arxiv.org/html/2601.16206v3#S3)。
...
- 证据定位：[Section 4.2, Table 9](https://arxiv.org/html/2601.16206v3#S4.T9)、[Section 4.3, Table 11](https://arxiv.org/html/2601.16206v3#S4.T11) 与 [Table 10 数据消融](https://arxiv.org/html/2601.16206v3#S4.T10)。
...
- 适用版本：论文数值对应 arXiv v3（2026-04-08）；实现说明核对 `llm-in-sandbox==0.2.0`、`cdx123/llm-in-sandbox:v0.1` 及两个官方仓库在 2026-07-21 的公开状态，未固定仓库 commit。
