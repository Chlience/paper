...
- 与已有论文的作者关系：当前未发现直接作者重叠；机构层面连接 Renmin University of China、Microsoft Research 和 Tsinghua University，补充 RUC GSAI / Microsoft Research GenAI 的 agentic LLM training 线。[Agentic RL 的可学习环境演进](/mainlines/agentic-rl-learned-environment-evolution/) 记录了 Huatong Song、Wayne Xin Zhao 与外部论文 SWE-World 的作者重叠。
