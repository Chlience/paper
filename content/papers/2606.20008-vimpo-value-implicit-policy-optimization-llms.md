...
- 与 [verl](https://github.com/verl-project/verl)：VIMPO 代码是 `verl` focused fork，直接落在 PPO/GRPO/DAPO/rollout correction 生态中；未来可和 `k2/k3`、rollout logprob、TIS/RS、async rollout 诊断联动。
