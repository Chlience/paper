...
- 与已有论文的方法或系统关系：与 [slime](/papers/2026-06-17-slime-rl-scaling-framework/) 和 [verl](/papers/2026-06-16-verl-rl-optimization-algorithms/) 的关系在实现层。两类框架提供 async rollout、behavior logprob、rollout correction、critic training 与 agent loop 等基础组件，SAO 没有披露具体 runtime 接入方式。
