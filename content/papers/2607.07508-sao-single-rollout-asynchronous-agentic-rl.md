...
pilot observation 显示 critic 的 attention gradient norm 明显高于 MoE layer。作者据此冻结 value model attention，只训练 MoE projections，并假设预训练 attention 已能从长上下文中选择 relevant state，critic 主要需要调整 state-to-value mapping。
