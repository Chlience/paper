...
- 与 [Gemma 4](/papers/2607.02770-gemma-4-technical-report/)：两篇材料共享 [Olivier Bachem](/authors/olivier-bachem/)、[Sabela Ramos](/authors/sabela-ramos/)、[Piotr Stanczyk](/authors/piotr-stanczyk/) 和 [Nino Vieillard](/authors/nino-vieillard/)；方法层分别对应 teacher-signal integration 与开放多模态模型/推理效率协同。
- 与 [verl](/papers/2026-06-16-verl-rl-optimization-algorithms/)：verl 的 async on-policy distill 将教师查询、学生 rollout 和 policy update 放入异步流水线，补充了 GKD 在大规模训练中的调度与吞吐问题。
