...
- 与 [GLM-5](/papers/2602.15763-glm-5-agentic-engineering/) 和 [GLM-5.2](/papers/2026-06-16-glm-5-2-long-horizon-tasks/)：GLM-5 把 DSA 迁移到另一模型并报告 20B token sparse adaptation，说明 943.7B 只是本报告采用的预算，不能直接推广为必要预算；GLM-5.2 的 IndexShare / IndexCache 进一步处理跨层 indices 复用与 indexer 成本。
