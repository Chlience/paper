...
### 5. Indexer、selector 与 selected softmax
...
### 7. MQA mode 与 masked MHA prefill
...
### 10. Thinking tool-use 与 agent task synthesis
...
- 与 [LLM-in-Sandbox](/papers/2601.16206-computer-environments-agentic-intelligence/) 和 [Agentic RL 的可学习环境演进](/mainlines/agentic-rl-learned-environment-evolution/)：V3.2 的 code/Jupyter/search 环境属于真实可执行环境，general-agent 环境由代码和数据库合成，转移函数仍由程序确定；可学习环境路线进一步用模型近似环境反馈。
