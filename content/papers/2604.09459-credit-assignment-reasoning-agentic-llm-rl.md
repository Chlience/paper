...
- 与 [LLM 与 Agent 强化学习中的信用分配](/mainlines/llm-agent-rl-credit-assignment/)：该主线把 survey 的 early-2026 taxonomy 延伸到 2026 年 5—7 月，并为 memory / compaction 方法增加状态可比性、来源路由与有符号时间信用三个审计维度。
