...
- [Zhentao Tan](/authors/zhentao-tan/): Alibaba Group；历史机构：Alibaba Cloud, University of Science and Technology of China.
- Wei Chen: Alibaba Group.
- Jingyi Shen: Alibaba Group.
- Yao Liu: Alibaba Group.
- [Xu Shen](/authors/xu-shen/): Alibaba Group；历史机构：Tongyi Large Model Business Unit, Alibaba Token Hub, University of Science and Technology of China.
- [Yue Wu](/authors/yue-wu-alibaba/): Alibaba Group；历史机构：Alibaba Cloud, University of Science and Technology of China.
- [Jieping Ye](/authors/jieping-ye/): Alibaba Group；历史机构：Data to Intelligence Lab, Alibaba Cloud Intelligence Group, University of Michigan.
...
### 7. Head-wise scale-normalized fusion
...
- Archive action: 新建独立 Markdown 笔记，并在 `content/utility/papers-index.md` 的 `当前收录` 中新增 HydraHead 索引行。
