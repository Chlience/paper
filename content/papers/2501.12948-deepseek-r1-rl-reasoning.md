...
- 索引状态：`content/utility/papers-index.md` 已包含 “Pure RL Reasoning Models 与 DeepSeek-R1 系谱” cluster，并把 R1 连接到 DAPO、TIM/VeXact、tool-calling RL、SocioHack、STV 和 inference determinism。
