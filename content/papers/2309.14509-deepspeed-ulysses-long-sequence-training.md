...
- [Sam Ade Jacobs](/authors/sam-ade-jacobs/): Microsoft Inc.
- Masahiro Tanaka: Microsoft Inc.
- Chengming Zhang: Microsoft Inc.
- Minjia Zhang: Microsoft Inc.
- Shuaiwen Leon Song: Microsoft Inc.
- [Samyam Rajbhandari](/authors/samyam-rajbhandari/): Microsoft Inc.
- [Yuxiong He](/authors/yuxiong-he/): Microsoft Inc.
...
- 与 [Prefill CP](/papers/2026-07-14-prefill-context-parallelism-inference-scaling/)：该综合将 UP 明确定义为 Ulysses Parallelism，使用 `[B,L/P,h,d] -> [B,L,h/P,d]` 的 all-to-all layout transpose，并与 Megatron SP 的 activation sharding、SGLang query-sharded Prefill CP 分开讨论。UP 可迁移到 Prefill inference，head / KV-head 可分性与 persistent KV layout 决定适用范围。
