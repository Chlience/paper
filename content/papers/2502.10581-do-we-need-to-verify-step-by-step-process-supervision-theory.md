...
- 与已有论文的作者关系：当前没有直接作者重叠；本次新增 [Zeyu Jia](/authors/zeyu-jia/)、[Alexander Rakhlin](/authors/alexander-rakhlin/) 和 [Tengyang Xie](/authors/tengyang-xie/) 作者档案。
...
- Proposed form: 新建独立 Markdown 文档 `2502.10581-do-we-need-to-verify-step-by-step-process-supervision-theory.md`，同步索引行和 Process Supervision 关系章节。
