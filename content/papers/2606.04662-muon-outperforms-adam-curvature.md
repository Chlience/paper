...
- 与工程材料的关系：本篇提供 curvature / NDS 机制解释；Keller Jordan 原始技术博客、KellerJordan/Muon 实现、Moonlight scale-up、Kimi K2 MuonClip、Convergence with Newton-Schulz、Muown 和 Gram Newton-Schulz 分别补充算法来源、扩展和工程变体。
