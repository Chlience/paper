...
### 6. Landmark token 产生 chunk summary
...
![Figure 3: HiLS-Attention 的压缩 chunk 检索与分层注意力](/images/papers/2607.02980-hils-attention-infinite-context/fig-3-hils-attention-overview.png)
...
### 7. Hierarchical softmax 让 selector 被 LM loss 训练
...
- 证据定位：[Section 3, Proposition 3.1、Equations 5–6](https://arxiv.org/html/2607.02980v1#S3.Thmproposition1)，证明见 Appendix B。
...
- 证据定位：[Section 5.1, 345M PPL 与 RULER 主结果表](https://arxiv.org/html/2607.02980v1#S5.SS1) 及 [Figure 1](https://arxiv.org/html/2607.02980v1#S0.F1) 的超长外推结果。
...
- 证据定位：[Section 5.2, 256K continued-training PPL 与 RULER 表](https://arxiv.org/html/2607.02980v1#S5.SS2)。
...
- 证据定位：[Section 6.1, 1.4B downstream 结果](https://arxiv.org/html/2607.02980v1#S6.SS1) 与 Appendix H 的 per-step PPL / RULER 表。
...
- 证据定位：[Section 6.2, OLMo3 CPT 结果](https://arxiv.org/html/2607.02980v1#S6.SS2)，包括 RULER、general tasks、PPL 与 LongBench-v1 表。
...
- 证据定位：[Section 7.1, Figure 6](https://arxiv.org/html/2607.02980v1#S7.F6)。
...
- 证据定位：[Section 5.3, 345M ablation PPL 与 RULER 表](https://arxiv.org/html/2607.02980v1#S5.SS3)。
