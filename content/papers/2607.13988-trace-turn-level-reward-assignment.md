...
- 与 [RL Credit Assignment Watch](/papers/2026-07-13-rl-credit-assignment-may-july-landscape/)：该综合已把检索截止扩展到 2026-07-22，并将 TRACE 纳入 `turn + frozen answer-likelihood + TD shaping + adjacent-prefix comparability` 路线；冻结参考策略也成为 policy topology 比较轴中的独立类型。
