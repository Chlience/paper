...
- 索引状态：`content/utility/papers-index.md` 已包含 “MiniMax-M1、Lightning Attention 与 CISPO” cluster，并连接到 Long-CoT RL Recipe、Training-Inference Mismatch、Agentic Tool-use RL、Reward Hacking 和 Long-context Serving。
