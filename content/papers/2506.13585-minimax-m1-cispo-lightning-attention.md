...
- 索引状态：`content/utility/papers-index.md` 的跨论文关系已把 MiniMax-M1 连接到 Long-CoT RL Recipe、Training-Inference Mismatch、Agentic Tool-use RL、Reward Hacking 和 Long-context Serving。
