...
- [Hunter Lightman](/authors/hunter-lightman/): OpenAI researcher / Member of Technical Staff；OpenAI Forum 介绍其关注 reasoning 与 large language model reliability，并说明本工作是其近期 process supervision 研究。
- [Vineet Kosaraju](/authors/vineet-kosaraju/): OpenAI researcher；个人主页说明其研究 general-purpose reasoning in language models，曾在 Mathgen / RL team 研究 grade-school math、single-step verifiers 和 robotics self-play。
- [Yura Burda](/authors/yura-burda/): OpenAI research scientist；MathAI4ED speaker page 说明其博士背景为数学，后续关注 machine learning for mathematical reasoning；Google Scholar 使用 Yuri Burda 拼写。
- [Harri Edwards](/authors/harri-edwards/): OpenAI / Google DeepMind 公开履历线索；OpenAI 2016 team update 记录其 Edinburgh PhD 背景；OpenReview 使用 Harrison Edwards 拼写，Google Scholar 也使用 Harrison Edwards。
- [Bowen Baker](/authors/bowen-baker/): OpenAI research scientist；个人主页显示其 OpenAI multi-agent RL 背景，后续本地归档 [2503.11926 CoT monitorability](/papers/2503.11926-monitoring-reasoning-models-obfuscation/) 中继续作为 OpenAI reasoning safety core author 出现。
- [Teddy Lee](/authors/teddy-lee/): 署名 OpenAI；公开线索主要来自论文、OpenReview 和 Scholar；LinkedIn 搜索结果显示其曾参与 OpenAI human data / fine-tuning data 相关工作。
- [Jan Leike](/authors/jan-leike/): 当前 Anthropic Alignment Science lead；个人主页说明其曾 co-led OpenAI Superalignment Team，并参与 InstructGPT、ChatGPT 和 GPT-4 alignment。
- [John Schulman](/authors/john-schulman/): OpenAI cofounder，PPO / TRPO / RLHF / KL estimator 关键作者；本地已归档其 [KL 近似技术博客](/papers/2020-03-07-schulman-kl-divergence-approximations/)。
- [Ilya Sutskever](/authors/ilya-sutskever/): OpenAI cofounder / former chief scientist；个人旧主页记录 OpenAI、Google Brain、DNNresearch 和 University of Toronto 背景；当前公开线索连接 Safe Superintelligence Inc.。
- [Karl Cobbe](/authors/karl-cobbe/): OpenAI research scientist；corresponding author；此前主导 GSM8K / verifier line 的 [Training Verifiers to Solve Math Word Problems](https://arxiv.org/abs/2110.14168)，GitHub `kcobbe` 也连接早期 OpenAI RL benchmark 代码。

关系判断：

- 同机构作者群：标题页全部标注 OpenAI，属于 OpenAI Mathgen / reasoning / alignment / RLHF 交叉线。
- 跨机构桥接：论文署名没有当前跨机构合作；作者背景连接 University of Toronto、MIT、University of Edinburgh、DeepMind / Anthropic、Safe Superintelligence Inc. 和后续 OpenAI reasoning safety 研究线。
- 与已存档作者重叠：[John Schulman](/authors/john-schulman/) 已在 KL estimator 笔记中建档；[Bowen Baker](/authors/bowen-baker/) 与 [2503.11926 CoT monitorability](/papers/2503.11926-monitoring-reasoning-models-obfuscation/) 直接重叠。
- 与已存档论文的主题或方法关系：与 [2605.25507 SRPO](/papers/2605.25507-credit-assignment-resets-language-model-reasoning/) 构成 process supervision 到 reset-based self-localized credit assignment 的历史前后关系；与 [2605.30290 STV](/papers/2605.30290-self-trained-verification/) 共享 verifier-guided self-improvement；与 [2512.07783 Interplay](/papers/2512.07783-interplay-pretraining-midtraining-rl-reasoning/) 共享 process-verified evaluation / process reward 语境；与 [2503.11926 CoT monitorability](/papers/2503.11926-monitoring-reasoning-models-obfuscation/) 形成 process signal 进入训练目标后的安全风险对照。
- 作者 profile pass：已检查主页、GitHub、Scholar/OpenReview、机构页和 X 候选。Hunter、Vineet、Bowen、Jan、Ilya、Karl 有较稳定 homepage / GitHub / Scholar 或机构来源；Harri 与 Yura 有 Scholar / OpenAI / workshop 来源但当前个人主页不稳定；Teddy 公开 profile 证据较弱，本次只记录论文和 Scholar / LinkedIn 搜索结果级线索，X 标记为 `not-found`。
...
- 与 `papers-index.md` 中已有论文的作者关系：[John Schulman](/authors/john-schulman/) 已在 [KL estimator](/papers/2020-03-07-schulman-kl-divergence-approximations/) 建档；[Bowen Baker](/authors/bowen-baker/) 与 [2503.11926 CoT monitorability](/papers/2503.11926-monitoring-reasoning-models-obfuscation/) 重叠。
...
- 新增后应更新的索引 cluster：新增 `Cluster AW: Process Supervision、PRM800K 与 Step-Level Verifier`，并在跨论文关系中把 `2305.20050` 接到 SRPO、STV、Interplay 和 CoT monitorability。
