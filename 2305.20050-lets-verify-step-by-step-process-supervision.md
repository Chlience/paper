...
| 理论反思 | [Do We Need to Verify Step by Step?](https://proceedings.mlr.press/v267/jia25f.html) | ICML 2025 理论工作指出，在标准 coverage 假设下 outcome supervision 的统计难度不高于 process supervision 到超多项式级别；经验差距更可能来自算法、优化和数据构造限制。 |
