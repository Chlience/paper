...
| 自动过程监督 / PRM 扩展 | Math-Shepherd、OmegaPRM、[Rewarding Progress](https://arxiv.org/abs/2410.08146) | 后续研究试图降低人工 step labels 成本，或把 process reward 定义成 progress / step-level advantage。Rewarding Progress 明确指出 dense human labels 成本不具备可扩展性，并把 process reward 设计为未来正确概率的变化。 |
