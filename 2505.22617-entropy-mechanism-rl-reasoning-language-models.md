...
- OpenReview withdrawn status 削弱正式学术背书。当前更适合作为高影响力 arXiv + 工程 recipe，尚不能作为完全定论。
...
| OpenReview reviewer comments | 页面显示 withdrawn submission，公开抓取页面未展示完整审稿文本。 |
