...
- [Ganqu Cui](/authors/ganqu-cui/): Shanghai AI Laboratory; equal contribution; homepage lists Tsinghua Ph.D., Shanghai AI Lab role, LLM alignment and reinforcement learning focus, PRIME-RL / Entropy Mechanism / RL compositionality line.
- [Yuchen Zhang](/authors/yuchen-zhang/): Shanghai AI Laboratory / Peking University; equal contribution; homepage identifies him as PKU Ph.D. student advised by Ning Ding and Bowen Zhou, working closely with Ganqu Cui and Yu Cheng.
- [Jiacheng Chen](/authors/jiacheng-chen/): Shanghai AI Laboratory in paper affiliation; equal contribution; homepage identifies CUHK Ph.D. student advised by Yu Cheng and Weiyang Liu, with MiniMax and Shanghai AI Lab internship experience.
- [Lifan Yuan](/authors/lifan-yuan/): UIUC; homepage identifies UIUC Ph.D. student advised by Hao Peng, with THUNLP / UIUC background and RL reasoning / scalable interaction research line.
- Zhi Wang: Nanjing University.
- Yuxin Zuo: Tsinghua University.
- Haozhan Li: Tsinghua University.
- Yuchen Fan: Shanghai AI Laboratory.
- [Huayu Chen](/authors/huayu-chen/): Tsinghua University; homepage identifies Tsinghua Ph.D. background, deep RL / generative model focus, Tianshou and LLM/VLM RL work.
- Weize Chen: Tsinghua University.
- Zhiyuan Liu: Tsinghua University.
- Hao Peng: UIUC.
- Lei Bai: Shanghai AI Laboratory.
- Wanli Ouyang: Shanghai AI Laboratory.
- [Yu Cheng](/authors/yu-cheng/): Shanghai AI Laboratory / CUHK; corresponding author; homepage identifies CUHK CSE associate professor, Skywork AI chief scientist, Shanghai AI Lab lead scientist/professor.
- [Bowen Zhou](/authors/bowen-zhou/): Shanghai AI Laboratory / Tsinghua University; corresponding author; TsinghuaC3I page identifies him as Tsinghua Department of Electronics permanent professor and Huiyan Chair Professor.
- [Ning Ding](/authors/ning-ding/): Tsinghua University / Shanghai AI Laboratory; corresponding author; homepage identifies Tsinghua EE assistant professor, PRIME-RL / THU-C3I lead, and scalable reasoning intelligence focus.

关系判断：

- 同机构作者群：Shanghai AI Laboratory 是主要组织节点，覆盖 Ganqu Cui、Yuchen Zhang、Jiacheng Chen、Yuchen Fan、Lei Bai、Wanli Ouyang、Yu Cheng、Bowen Zhou、Ning Ding；Tsinghua University 作者群覆盖 Yuxin Zuo、Haozhan Li、Huayu Chen、Weize Chen、Zhiyuan Liu、Bowen Zhou、Ning Ding；UIUC 作者群覆盖 Lifan Yuan、Hao Peng。
- 跨机构桥接：Ning Ding 和 Bowen Zhou 连接 Tsinghua 与 Shanghai AI Laboratory；Yu Cheng 连接 Shanghai AI Laboratory 与 CUHK；Yuchen Zhang 连接 Shanghai AI Laboratory 与 Peking University；Ganqu Cui 连接 Shanghai AI Laboratory 与 THUNLP / Tsinghua 既有研究线。
- 与已存档作者重叠：本篇与 [2509.25123](/papers/2509.25123-rl-compositional-skill-acquisition/) 存在强作者重叠，包含 Lifan Yuan、Yuchen Zhang、Ganqu Cui、Weize Chen、Ning Ding、Zhiyuan Liu、Hao Peng。Ganqu Cui、Lifan Yuan、Huayu Chen、Yu Cheng、Zhiyuan Liu、Hao Peng、Bowen Zhou、Ning Ding 也出现在 PRIME / ImplicitPRM 相关工作中。
- 与已存档论文的主题或方法关系：本篇处在 [2501.12948 DeepSeek-R1](/papers/2501.12948-deepseek-r1-rl-reasoning/)、[2503.14476 DAPO](/papers/2503.14476-dapo-long-cot-rl-system/)、[2026-06-16 verl](/papers/2026-06-16-verl-rl-optimization-algorithms/) 和 [2504.13837 RLVR boundary](/papers/2504.13837-rlvr-reasoning-boundary-base-model/) 之间，给 long-CoT / RLVR 的 entropy collapse、exploration exhaustion 和 policy update concentration 提供机制解释。
- 作者页决策：核心作者和通讯作者 tracked；Zhi Wang、Yuxin Zuo、Haozhan Li、Yuchen Fan、Weize Chen、Zhiyuan Liu、Hao Peng、Lei Bai、Wanli Ouyang 在本轮保留在论文页，原因是本任务重点为论文机制分析，未对每位 coauthor 做足够独立身份核验。
...
- 更高 entropy 和更好 exploration 之间不总是同义。无约束的 entropy bonus 已经显示可能损害 performance。有效 entropy 应该指向 reward-relevant low-probability paths，而非随机生成更多无效 token。
...
| Material | Reason |
| --- | --- |
| 全部 17 位作者的完整 X account pass | 本轮重点是论文机制分析；核心作者与通讯作者已建档，其他 coauthors 暂在论文页记录机构和跳过原因。 |
