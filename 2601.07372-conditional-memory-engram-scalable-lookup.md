...
- Wangding Zeng: DeepSeek-AI；在 [2405.04434 DeepSeek-V2](/papers/2405.04434-deepseek-v2-mla-moe-efficient-llm/) 中被标注为 MLA architecture innovations 贡献者之一，也出现在 DeepSeekMoE、DeepSeek-V2/R1/V4 等 DeepSeek 系列作者线索中。
- [Damai Dai](/authors/damai-dai/): DeepSeek-AI / Peking University；已在 Math-Shepherd、DeepSeekMoE、DeepSeek-V3 等条目中建档。
...
1. [DeepSeek-V2](/papers/2405.04434-deepseek-v2-mla-moe-efficient-llm/) 用 MLA (Multi-head Latent Attention，多头潜变量注意力) 压低 KV cache，用 DeepSeekMoE 扩大 total 参数并控制 active compute。
...
- 与 `papers-index.md` 中已有论文的作者关系：[Damai Dai](/authors/damai-dai/) 已在 Math-Shepherd / DeepSeekMoE / DeepSeek-V3 线索中建档；Wangding Zeng、Xingkai Yu、Wenfeng Liang 与 DeepSeek 系列存在强重叠，暂未建独立作者页。
...
- 与已有论文的方法或系统关系：继承 [DeepSeek-V2](/papers/2405.04434-deepseek-v2-mla-moe-efficient-llm/) 的 MLA / DeepSeekMoE 效率路线，使用 Muon 背景可连接 [Muon 综合分析](/papers/2026-06-19-muon-optimizer-keller-jordan-synthesis/) 和 [2606.04662](/papers/2606.04662-muon-outperforms-adam-curvature/)；长上下文收益与 [Dynamic Linear Attention](/papers/2606.10650-dynamic-linear-attention/)、[MiniMax-M1](/papers/2506.13585-minimax-m1-cispo-lightning-attention/) 和 DeepSeek-V4 构成长上下文架构对照。
