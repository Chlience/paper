...
- Yucheng Li: Qwen Team, Alibaba Inc.; equal contribution marker.
- Huiqiang Jiang: Qwen Team, Alibaba Inc.; equal contribution and corresponding author marker.
...
- 同机构作者群：全体作者署名 Qwen Team, Alibaba Inc.，属于 Qwen 后训练、推理系统和 MTP/rollout acceleration 共同工程线。
- 跨机构桥接：标题页未显示外部机构合作；当前记录为 Alibaba/Qwen 内部团队产出。
- equal contribution / corresponding author：Yucheng Li 与 Huiqiang Jiang 标记 equal contribution；Huiqiang Jiang 标记 corresponding author。
- 与已存档作者重叠：与 [Qwen2.5](/papers/2412.15115-qwen2-5-technical-report/) 和 [Qwen3](/papers/2505.09388-qwen3-technical-report/) 技术报告存在多名直接重叠作者，包括 [An Yang](/authors/an-yang-qwen/)、[Bowen Yu](/authors/bowen-yu-qwen/)、[Bo Zheng](/authors/bo-zheng-qwen/)、[Rui Men](/authors/rui-men/)、[Jianwei Zhang](/authors/jianwei-zhang-qwen/)、[Jianxin Yang](/authors/jianxin-yang-qwen/)、[Fei Huang](/authors/fei-huang-qwen/)、[Junyang Lin](/authors/junyang-lin/)、[Dayiheng Liu](/authors/dayiheng-liu/)、[Jingren Zhou](/authors/jingren-zhou-qwen/)。
- 与已存档论文的主题或方法关系：强连接 [2211.17192 Fast Inference from Transformers via Speculative Decoding](/papers/2211.17192-fast-inference-transformers-speculative-decoding/)、[VERL-2026-06-16](/papers/2026-06-16-verl-rl-optimization-algorithms/)、[2511.14617](/papers/2511.14617-seer-online-context-learning-llm-rl/)、[2602.15763](/papers/2602.15763-glm-5-agentic-engineering/)、[2506.13585](/papers/2506.13585-minimax-m1-cispo-lightning-attention/)、[2026-04-24](/papers/2026-04-24-deepseek-v4-million-token-context-intelligence/)、[2605.14220](/papers/2605.14220-training-inference-mismatch-llm-rl/)。
- 需要后续确认：SGLang PR 与 vLLM PR 的最终 merge 状态、Bebop 是否会随 Qwen3.7 系列模型或独立 MTP heads 发布、Qwen3.5/3.6/3.7 具体模型规格与训练数据细节。
...
- 与 [2026-06-16](/papers/2026-06-16-verl-rl-optimization-algorithms/)：本论文补充了 verl 当前文档中 MTP 的核心机理。verl 文档提醒 H20 等硬件上 MTP 未必总能提升 throughput；Bebop 解释一个上游条件：acceptance method、TV loss 和 entropy coverage 会决定 MTP 是否能在 RL rollout 中稳定收益。
...
- Existing related assets: [VERL-2026-06-16](/papers/2026-06-16-verl-rl-optimization-algorithms/)、[2511.14617](/papers/2511.14617-seer-online-context-learning-llm-rl/)、[2602.15763](/papers/2602.15763-glm-5-agentic-engineering/)、[2506.13585](/papers/2506.13585-minimax-m1-cispo-lightning-attention/)、[2026-04-24](/papers/2026-04-24-deepseek-v4-million-token-context-intelligence/)。
- Proposed form: 新建独立 Markdown 文档，并在索引中新建 Qwen/Bebop/MTP cluster。
...
- Overlap with existing assets: 与 verl/Seer/GLM-5/MiniMax-M1 的 overlap 已通过跨论文关系区分。
