...
| Existing local paper notes and `papers-index.md` | Cross-paper relationship mapping | High | Used to connect GKD to MOPD, Qwen3, DeepSeek-V4, GLM-5.2, and verl-related OPD discussion. |
