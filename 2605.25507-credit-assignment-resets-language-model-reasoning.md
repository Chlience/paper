...
- [Ankur Samanta](/authors/ankur-samanta/): Columbia University AI/BME PhD candidate；GitHub profile 标注 Research @ MetaAI；论文脚注标注 work done at Meta；通讯邮箱为 Columbia 地址。
- [Akshayaa Magesh](/authors/akshayaa-magesh/): UIUC ECE / CSL PhD profile；论文署名 Meta AI。
- [Ayush Jain](/authors/ayush-jain/): Meta Applied Reinforcement Learning team research scientist；主页列出这篇 reset 论文、`Structure Enables Effective Self-Localization of Errors in LLMs`、MACA 和 multi-task RL gradient imbalance 等同一条 LLM RL 研究线。
- [Youliang Yu](/authors/youliang-yu/): 论文署名 Meta AI；公开 profile 证据主要来自 LinkedIn 与同组论文署名。
- [Daniel R. Jiang](/authors/daniel-r-jiang/): Meta AI research scientist，主页说明工作集中在 reinforcement learning、RLHF、long-horizon planning 和 information acquisition。
- [Kavosh Asadi](/authors/kavosh-asadi/): Meta RL team senior scientist；主页强调 RL theory、value function optimization 和 assistive AI agents。
- [Kaveh Hassani](/authors/kaveh-hassani/): Meta Superintelligence Labs research scientist；主页说明其关注 self-improving LLMs、LLM reasoning、multi-agent RL 和 post-training。
- [Paul Sajda](/authors/paul-sajda/): Columbia University professor，LIINC lab PI；OpenReview profile 和 Columbia pages 均连接其 Biomedical Engineering / BCI / decision-making 背景。
- [Jalaj Bhandari](/authors/jalaj-bhandari/): Columbia OR PhD profile显示其研究 RL theory、optimization 和 applied RL；Google Scholar 当前显示 Meta verified email。
- [Yonathan Efroni](/authors/yonathan-efroni/): Tel Aviv University School of Computer Science and AI assistant professor；TAU profile 说明其曾在 Meta 做 RL / robust algorithms / auction systems，当前关注 interactive learning、agentic systems 和 LMs。

关系判断：

- 同机构作者群：Meta AI 是核心组织，覆盖 Akshayaa Magesh、Ayush Jain、Youliang Yu、Daniel R. Jiang、Kavosh Asadi、Jalaj Bhandari；Kaveh Hassani 连接 Meta Superintelligence Labs；Ankur Samanta 的脚注说明工作完成于 Meta。
- 跨机构桥接：Ankur Samanta 连接 Columbia 与 Meta；Paul Sajda 代表 Columbia LIINC；Yonathan Efroni 连接 TAU 与此前 Meta RL 背景；Kaveh Hassani 连接 MSL 与 Meta Ranking / foundational AI 线。
- 与已存档作者重叠：当前 `authors.json` 之前未收录这组作者；本次新增作者 profile。
- 与已存档论文的主题或方法关系：与 [2503.14476 DAPO](/papers/2503.14476-dapo-long-cot-rl-system/)、[2602.07078 OTB](/papers/2602.07078-optimal-token-baseline-long-horizon-llm-rl/)、[2606.20008 VIMPO](/papers/2606.20008-vimpo-value-implicit-policy-optimization-llms/) 共同处理 RLVR 中 outcome reward 的 credit assignment；与 [2605.30290 STV](/papers/2605.30290-self-trained-verification/) 共同利用 verifier / resampling 做 self-improvement；与 [2504.13837 RLVR boundary](/papers/2504.13837-rlvr-reasoning-boundary-base-model/) 和 [2506.10947 Spurious Rewards](/papers/2506.10947-spurious-rewards-rethinking-rlvr/) 共同提醒最终分数提升需要区分真实能力扩展、base prior amplification 和 verifier artifact。
- 作者 profile pass：已检查主页、GitHub、Scholar/OpenReview、机构页和 X 候选。Ankur、Ayush、Daniel、Kavosh、Kaveh 的 X 账号来自个人主页或 GitHub 直接链接；Akshayaa、Youliang、Paul、Jalaj、Yonathan 当前未发现高置信个人 X。
...
| 本地归档相关 | [DAPO](/papers/2503.14476-dapo-long-cot-rl-system/), [VERL](/papers/2026-06-16-verl-rl-optimization-algorithms/), [Entropy Mechanism](/papers/2505.22617-entropy-mechanism-rl-reasoning-language-models/), [RLVR Boundary](/papers/2504.13837-rlvr-reasoning-boundary-base-model/), [Spurious Rewards](/papers/2506.10947-spurious-rewards-rethinking-rlvr/), [STV](/papers/2605.30290-self-trained-verification/) | DAPO / VERL 给 RLVR recipe 和系统背景；Entropy / Boundary / Spurious Rewards 提供收益来源和训练动力学诊断；STV 与 SRPO 都利用 verifier / resampling，但 STV 强调 verifier 自训练，SRPO 强调 reset 后缀 credit。 |
...
- 与 [2503.14476 DAPO](/papers/2503.14476-dapo-long-cot-rl-system/) 和 [2026-06-16 VERL](/papers/2026-06-16-verl-rl-optimization-algorithms/)：DAPO / VERL 提供 long-CoT GRPO recipe 和系统实现背景；SRPO 可以视作 rollout construction / loss masking 层的新 recipe。
...
- 新增索引 cluster：`Cluster AV: Reset-Based Credit Assignment 与 Self-Localized RLVR`。
...
- Existing related assets: `papers-index.md`、`authors.json`、[OTB](/papers/2602.07078-optimal-token-baseline-long-horizon-llm-rl/)、[VIMPO](/papers/2606.20008-vimpo-value-implicit-policy-optimization-llms/)、[DAPO](/papers/2503.14476-dapo-long-cot-rl-system/)、[VERL](/papers/2026-06-16-verl-rl-optimization-algorithms/)、[Entropy Mechanism](/papers/2505.22617-entropy-mechanism-rl-reasoning-language-models/)。
- Proposed form: 新建独立 Markdown 文档；同步 `papers-index.md` 和 `authors.json`。
...
- Unsourced or unverifiable claims: 理论、实验设置和数值来自 arXiv v2 / TeX source；作者 profile 来自主页、GitHub、Scholar/OpenReview、机构页；未确认的 X 保持 `not-found`。
...
- Overlap with existing assets: 与 OTB/VIMPO/DAPO/VERL 等已有节点通过 cross-paper relation 合并，避免重复建宽泛 RLVR 条目。
...
| 低置信 X 候选 | Akshayaa Magesh、Youliang Yu、Paul Sajda、Jalaj Bhandari、Yonathan Efroni 未发现由主页/GitHub/机构页交叉确认的个人 X。 |
