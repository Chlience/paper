...
- Shizhe Diao: NVIDIA；邮箱 `sdiao@nvidia.com`。
- Ximing Lu: NVIDIA；邮箱 `ximingl@nvidia.com`。
- Jian Hu: NVIDIA；邮箱 `jianh@nvidia.com`。
...
- 项目组织：标题页加粗 Xin Dong、Yejin Choi、Jan Kautz、Yi Dong，关系判断上更接近 senior / supervising authors；论文发布 NVIDIA Nemotron-Research-Reasoning-Qwen-1.5B 权重，属于 NVIDIA Nemotron 研究线。
