...
### 6. Lightning Attention 下的 RL 稳定性问题
...
### 8. 40K 到 80K 的 long thinking 扩展
...
- 新增后应更新的索引 cluster：新增 “MiniMax-M1、Lightning Attention 与 CISPO” cluster，并连接到 Long-CoT RL Recipe、Training-Inference Mismatch、Agentic Tool-use RL、Reward Hacking 和 Long-context Serving。
...
- Proposed form: 新建独立 Markdown 文档，并更新总索引和跨论文关系。
