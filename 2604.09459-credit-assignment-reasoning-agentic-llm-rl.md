...
- [Chenchen Zhang](/authors/chenchen-zhang/): arXiv 标注 Independent Researcher，联系邮箱 `zcc1959339538@gmail.com`；GitHub / Hugging Face handle 均为 `xxzcc`；Hugging Face profile 链接 Google Scholar `WmzUNaQAAAAJ`，Scholar 搜索摘要显示 Alibaba -> Tencent-HY / verified tencent.com 线索，但当前论文标题页仍按 Independent Researcher 记录。

关系判断：

- 同机构作者群：单作者综述，无同机构作者群。
- 跨机构桥接：论文标题页给出 Independent Researcher；公开 profile signal 显示 GitHub pinned repos、Hugging Face 组织和 Scholar 可能连接 Tencent-Hunyuan / Alibaba / Multimodal Art Projection，当前只作为作者 profile 线索，不上升为论文机构背书。
- 与已存档作者重叠：此前未在 `authors.json` 收录 Chenchen Zhang。
- 与已存档论文的主题或方法关系：这是 credit assignment 主题的综述地图，直接连接 [2602.07078 OTB](/papers/2602.07078-optimal-token-baseline-long-horizon-llm-rl/)、[2605.25507 SRPO](/papers/2605.25507-credit-assignment-resets-language-model-reasoning/)、[2606.20008 VIMPO](/papers/2606.20008-vimpo-value-implicit-policy-optimization-llms/)、[2305.20050 PRM800K](/papers/2305.20050-lets-verify-step-by-step-process-supervision/)、[2312.08935 Math-Shepherd](/papers/2312.08935-math-shepherd-automatic-process-supervision/)、[2605.30290 STV](/papers/2605.30290-self-trained-verification/)、[2512.23075 TRM](/papers/2512.23075-trust-region-masking-long-horizon-llm-rl/)、[2605.14220 TIM/VeXact](/papers/2605.14220-training-inference-mismatch-llm-rl/) 和 [2606.00135 tool-calling RL](/papers/2606.00135-agentic-tool-calling-rl-training/)。
- 作者 profile pass：已检查 arXiv、GitHub profile、GitHub repos、Hugging Face profile、Scholar link、OpenReview/公开搜索和 X 候选。`@chenchenzh` 对应国际关系方向同名作者，和本论文作者缺少交叉证据，因此不记录 X。
...
- 新增后应更新的索引 cluster：`Cluster AS: LLM RL Credit Assignment Survey 与 Reasoning-to-Agentic Taxonomy`。

## Reference Intake Brief

### Target

- Intended target system: 新增论文笔记与 `papers-index.md` credit assignment 图谱。
- Existing related assets: [2602.07078 OTB](/papers/2602.07078-optimal-token-baseline-long-horizon-llm-rl/), [2605.25507 SRPO](/papers/2605.25507-credit-assignment-resets-language-model-reasoning/), [2606.20008 VIMPO](/papers/2606.20008-vimpo-value-implicit-policy-optimization-llms/), [2305.20050 PRM800K](/papers/2305.20050-lets-verify-step-by-step-process-supervision/), [2312.08935 Math-Shepherd](/papers/2312.08935-math-shepherd-automatic-process-supervision/), [2605.30290 STV](/papers/2605.30290-self-trained-verification/), [2512.23075 TRM](/papers/2512.23075-trust-region-masking-long-horizon-llm-rl/), [2605.14220 TIM/VeXact](/papers/2605.14220-training-inference-mismatch-llm-rl/), [2606.00135 tool-calling RL](/papers/2606.00135-agentic-tool-calling-rl-training/), `papers-index.md`。
- Proposed form: 新建独立 Markdown 文档，更新索引当前收录、作者关系图谱和跨论文关系。
...
- Unsourced or unverifiable claims: 作者机构以 arXiv 标题页为准；GitHub/HF/Scholar 只作为 profile signal；X 候选未能交叉验证。
