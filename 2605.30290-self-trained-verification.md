...
- [Chen Henry Wu](/authors/chen-henry-wu/): Carnegie Mellon University PhD student；个人 CV 记录其 advisor 为 Aditi Raghunathan，并列出这篇为 NeurIPS 2026 under review。
- [Aditi Raghunathan](/authors/aditi-raghunathan/): Carnegie Mellon University faculty；项目页和代码仓库均落在 AR-FORUM / A|Raghunathan Lab 线索下。

关系判断：

- 同机构关系：两位作者均属 Carnegie Mellon University；这是一篇小作者组的 lab-line paper，更像 focused agenda，而非多机构系统大协作。
- 指导关系：Chen Henry Wu 个人 CV 标注 Aditi Raghunathan 为博士 advisor；论文项目页和 GitHub 也共同指向 AR-FORUM。
- 与已存档作者重叠：与 [2510.20270 ImpossibleBench](/papers/2510.20270-impossiblebench-test-case-exploitation/) 存在 [Aditi Raghunathan](/authors/aditi-raghunathan/) 直接重叠；两篇都关注 feedback / evaluator loop 的可靠性边界。
- 与已存档论文的主题关系：连接 [2305.20050 PRM800K](/papers/2305.20050-lets-verify-step-by-step-process-supervision/)、[2312.08935 Math-Shepherd](/papers/2312.08935-math-shepherd-automatic-process-supervision/)、[2605.25507 SRPO](/papers/2605.25507-credit-assignment-resets-language-model-reasoning/)、[2502.10581 process supervision theory](/papers/2502.10581-do-we-need-to-verify-step-by-step-process-supervision-theory/)、[2504.13837 RLVR boundary](/papers/2504.13837-rlvr-reasoning-boundary-base-model/) 和 [2506.10947 Spurious Rewards](/papers/2506.10947-spurious-rewards-rethinking-rlvr/)。
- 工程线索：GitHub 提供 reference implementation，并包含 customized `verl` fork；README 说明训练假设单个 8-GPU node、vLLM、FlashAttention 和 PyTorch CUDA 环境。
