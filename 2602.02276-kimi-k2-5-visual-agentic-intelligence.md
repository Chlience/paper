...
- 新增后应更新的索引 cluster：Kimi K2.5、Multimodal Agentic Intelligence 与 Agent Swarm。
...
- Proposed form: 新建 `2602.02276-kimi-k2-5-visual-agentic-intelligence.md`，并更新 index 与已有作者条目。
