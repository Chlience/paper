...
- 每篇论文必须沉淀为 `content/papers/<slug>.md`，并更新 `content/utility/papers-index.md`。
- 每篇论文必须包含 `Source`、`作者与关系`、`一句话结论`、`论文脉络`、`关键实验/定理`、`局限`、`Reference Intake Brief`。
- 每篇论文阅读后的交流环节必须提炼并回写到对应 Markdown，优先放入 `本地讨论补充`；若交流内容改变跨论文关系或主题判断，同步更新 `content/utility/papers-index.md`。
