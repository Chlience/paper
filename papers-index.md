...
- Internal relation: Tri Dao、Daniel Y. Fu、Stefano Ermon、Christopher Ré 属 Stanford University；Atri Rudra 属 University at Buffalo, SUNY，连接理论计算机科学与系统/kernel 设计；代码最初由 HazyResearch 发布，当前官方实现由 Dao-AILab 维护。
- Theme relation: FlashAttention, exact softmax attention, IO-aware algorithm, HBM/SRAM memory hierarchy, tiling, online softmax, kernel fusion, backward recomputation, block-sparse FlashAttention, CUDA, long-context training。
