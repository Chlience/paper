...
| 2409.19256 | HybridFlow: A Flexible and Efficient RLHF Framework | [2409.19256-hybridflow-rlhf-framework.md](/papers/2409.19256-hybridflow-rlhf-framework/) | RLHF systems, distributed post-training infrastructure, VERL | [Guangming Sheng](/authors/guangming-sheng/), Chuan Wu / The University of Hong Kong; [Chi Zhang](/authors/chi-zhang/), Zilingfeng Ye, Xibin Wu, [Wang Zhang](/authors/wang-zhang/), Ru Zhang, Yanghua Peng, [Haibin Lin](/authors/haibin-lin/) / ByteDance |
...
- Internal relation: [Guangming Sheng](/authors/guangming-sheng/) 与 Chuan Wu 属 HKU；[Chi Zhang](/authors/chi-zhang/)、Zilingfeng Ye、Xibin Wu、[Wang Zhang](/authors/wang-zhang/)、Ru Zhang、Yanghua Peng、[Haibin Lin](/authors/haibin-lin/) 属 ByteDance；论文受 ByteDance Research Collaboration Project 与 Hong Kong RGC 支持。
...
- `2205.14135` 和 `2307.08691` 共同形成 FlashAttention family 基础节点，并连接 Lightning Attention、DLA、MiniMax-M1、DeepSeek-V4、Vortex、Parrot/Span Query、inference determinism 和 TIM/VeXact。FA1 提供 HBM/SRAM data movement 语言；FA2 进一步提供 non-matmul FLOPs、sequence parallelism、SM occupancy 和 warp work partitioning 语言。
