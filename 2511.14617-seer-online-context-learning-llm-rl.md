...
- [Mingxing Zhang](/authors/mingxing-zhang/): Tsinghua University; corresponding author, `zhang_mingxing@mail.tsinghua.edu.cn`.

关系判断：

- 同机构作者群：Moonshot AI 作者群覆盖 [Weiran He](/authors/weiran-he/)、[Weixiao Huang](/authors/weixiao-huang/)、[Yangkun Zhang](/authors/yangkun-zhang/)、[Yikai Zhao](/authors/yikai-zhao/)、[Bo Pang](/authors/bo-pang/)、[Xinran Xu](/authors/xinran-xu/)，并通过 [Ruoyu Qin](/authors/ruoyu-qin/) 连接 Tsinghua；Tsinghua University 作者群覆盖 [Ruoyu Qin](/authors/ruoyu-qin/)、[Yingdi Shan](/authors/yingdi-shan/)、[Yongwei Wu](/authors/yongwei-wu/)、[Mingxing Zhang](/authors/mingxing-zhang/)。
- 跨机构桥接：[Ruoyu Qin](/authors/ruoyu-qin/) 具有 Moonshot AI 和 Tsinghua University 双重署名，是产业训练系统与高校系统研究之间的桥接作者；[Mingxing Zhang](/authors/mingxing-zhang/) 为通讯作者，承担 Tsinghua 侧沟通角色。
- 与已存档作者重叠：未发现与当前已存档论文的明确直接作者重叠。存在 Tsinghua 机构网络关联，包括 [2503.14476](/papers/2503.14476-dapo-long-cot-rl-system/)、[2504.13837](/papers/2504.13837-rlvr-reasoning-boundary-base-model/)、[2509.25123](/papers/2509.25123-rl-compositional-skill-acquisition/)、[2602.15763](/papers/2602.15763-glm-5-agentic-engineering/)。
- 与已存档论文的主题或方法关系：强连接 [2409.19256](/papers/2409.19256-hybridflow-rlhf-framework/)、[2602.15763](/papers/2602.15763-glm-5-agentic-engineering/)、[2503.14476](/papers/2503.14476-dapo-long-cot-rl-system/)、[2510.01180](/papers/2510.01180-brorl-broadened-rl-exploration/)、[2506.13585](/papers/2506.13585-minimax-m1-cispo-lightning-attention/)、[2511.02749](/papers/2511.02749-span-queries-cache-attention-locality/)、[2405.19888](/papers/2405.19888-parrot-semantic-variable-llm-serving/)。
- 需要后续确认：是否会公开 Seer 代码、Moonshot 内部 production workloads 细节、Mooncake global KVCache pool 的可复现配置；若作者后续公开个人 X 账号，按 `author-x-account-search-sop.md` 复核后更新 `authors.json`。
...
- 2026-06-17 按 `author-x-account-search-sop.md` 执行作者账号搜索后，未发现任何作者有高置信度个人 X 账号。已把 [Ruoyu Qin](/authors/ruoyu-qin/)、[Weiran He](/authors/weiran-he/)、[Weixiao Huang](/authors/weixiao-huang/)、[Yangkun Zhang](/authors/yangkun-zhang/)、[Yikai Zhao](/authors/yikai-zhao/)、[Bo Pang](/authors/bo-pang/)、[Xinran Xu](/authors/xinran-xu/)、[Yingdi Shan](/authors/yingdi-shan/)、[Yongwei Wu](/authors/yongwei-wu/)、[Mingxing Zhang](/authors/mingxing-zhang/) 写入 `authors.json`。其中 Ruoyu Qin、Yingdi Shan、Yongwei Wu、Mingxing Zhang 的公开主页或机构页最完整；Weiran He、Weixiao Huang、Yikai Zhao 主要由 MADSys/GitHub/professional profile 支撑；Yangkun Zhang、Bo Pang 目前以 Seer/Kimi 团队署名为主要公开证据。Moonshot/Kimi 的组织账号只作为项目线索，不记录为个人账号。
