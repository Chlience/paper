...
- [Jian Chen](/authors/jian-chen-ucsd/): UC San Diego first-year PhD student advised by Zhijian Liu；homepage lists DFlash and MagicDec, and links Scholar, GitHub `jianc99`, X `jianchen1799`.
- [Yesheng Liang](/authors/yesheng-liang/): UC San Diego Z Lab PhD student supervised by Zhijian Liu；homepage lists DFlash as ICML 2026 and ParoQuant as ICLR 2026, and links GitHub `liang2kl`, X `yesheng_liang`.
- [Zhijian Liu](/authors/zhijian-liu/): UC San Diego Assistant Professor, Z Lab director, NVIDIA Research Scientist；corresponding author in TeX source.

关系判断：

- 同机构作者群：三位作者均属 UC San Diego / Z Lab。Jian Chen 与 Yesheng Liang 是 PhD student，Zhijian Liu 是 PI 和 corresponding author。
- 跨机构桥接：Zhijian Liu 同时连接 UC San Diego 和 NVIDIA；acknowledgement 感谢 Qualcomm、Amazon、Modal、Yotta Labs、Eigen AI、InnoMatrix 提供支持或 compute；README 感谢 SGLang、Modal 和 NVIDIA vLLM 相关贡献者。
- 与已存档作者重叠：无直接作者重叠。方法上与 [2211.17192 Speculative Decoding](/papers/2211.17192-fast-inference-transformers-speculative-decoding/)、[2606.12370 Bebop](/papers/2606.12370-bebop-mtp-rejection-sampling-rl-training/) 和 [2511.14617 Seer](/papers/2511.14617-seer-online-context-learning-llm-rl/) 重叠较强。
- 与已存档论文的主题或方法关系：DFlash 继承 speculative decoding 的 target verification / acceptance 语言，把 draft source 从 autoregressive tree / MTP head 推向 block diffusion drafter；它的 serving 结果直接连接 SGLang / vLLM 生态和 Qwen3 模型族。
- 需要后续确认：ICML 2026 camera-ready 状态来自 arXiv 注释和 TeX style；未找到公开 reviewer comments，因此没有 reviewer-level 可信度校准。
...
- 与 `papers-index.md` 中已有论文的作者关系：无直接作者重叠。新增 UC San Diego / Z Lab 作者节点 Jian Chen、Yesheng Liang、Zhijian Liu。
...
- Existing related assets: `papers-index.md`；[2211.17192](/papers/2211.17192-fast-inference-transformers-speculative-decoding/)；[2606.12370](/papers/2606.12370-bebop-mtp-rejection-sampling-rl-training/)；[2511.14617](/papers/2511.14617-seer-online-context-learning-llm-rl/)；[2505.09388](/papers/2505.09388-qwen3-technical-report/)。
